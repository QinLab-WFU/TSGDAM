...
class CoordAtt(nn.Module):
    def __init__(self, inp, oup, reduction=32):
        ...
        self.pool_h = nn.AdaptiveAvgPool2d((None, 1))  # wc面池化为1个值
        self.pool_w = nn.AdaptiveAvgPool2d((1, None))  # hc面池化为1个值

        # self.att_h = MultiSpectralAttentionLayer(w, 7, 7, reduction=16, freq_sel_method='top16', pool_type='ch')
        # self.att_w = MultiSpectralAttentionLayer(h, 7, 7, reduction=16, freq_sel_method='top16', pool_type='cw')
    ...
    def forward(self, x):
        ...
        # x_h = self.att_h(x).permute(0, 3, 2, 1)
        # x_w = self.att_w(x).permute(0, 2, 1, 3)
